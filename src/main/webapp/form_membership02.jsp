...
<body>
	<%
		...
		String m_ph02 = request.getParameter("phone2");//전화번호 가운데
		String m_ph03 = request.getParameter("phone3");//전화번호 마지막
		
		String m_gender = request.getParameter("gender");//성별(남,여 中 1)
